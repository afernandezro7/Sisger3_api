 ...
 * Ajuste
 *
 * @ORM\Table(name="ajuste", uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_DA99B804C949A274", columns={"entrada"})}, indexes={@ORM\Index(name="IDX_DA99B804E766A51E", columns={"banking"})})
 * @ORM\Entity
 */
class Ajuste
{
